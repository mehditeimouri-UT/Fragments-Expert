function [NaiveBayes,NaiveBayes_CL,Pc,ConfusionMatrix,Pc_Train,ConfusionMatrix_Train] = Build_NaiveBayes_FFC(Dataset,ClassLabels,FeatureLabels,Weights,TIndex,VIndex)
...
[~,Pc_Train,ConfusionMatrix_Train,~,~] = Test_NaiveBayes_FFC(NaiveBayes,Dataset,TIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);
[~,Pc,ConfusionMatrix,~,~] = Test_NaiveBayes_FFC(NaiveBayes,Dataset,VIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);