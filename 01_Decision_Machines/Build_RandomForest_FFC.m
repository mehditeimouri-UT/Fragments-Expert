function [RandomForest_CL,Pc,ConfusionMatrix,Pc_Train,ConfusionMatrix_Train] = Build_RandomForest_FFC(RandomForest_CL,Dataset,ClassLabels,FeatureLabels,Weights,TIndex,VIndex,NumTrees,MinLeafSize)
...
%
% Revisions:
% 2020-Mar-14   function was created
...
[~,Pc_Train,ConfusionMatrix_Train,~,~] = Test_RandomForest_FFC(RandomForest_CL,Dataset,TIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);
[~,Pc,ConfusionMatrix,~,~] = Test_RandomForest_FFC(RandomForest_CL,Dataset,VIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);