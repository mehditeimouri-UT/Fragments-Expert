function [PRNN,Pc,ConfusionMatrix,Pc_Train,ConfusionMatrix_Train] = Build_PatternRecognitionNeuralNetwork_FFC(Dataset,ClassLabels,FeatureLabels,Weights,TIndex,VIndex,hiddenSize)
...
[~,Pc_Train,ConfusionMatrix_Train,~,~] = Test_PatternRecognitionNeuralNetwork_FFC(PRNN,Dataset,TIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);
[~,Pc,ConfusionMatrix,~,~] = Test_PatternRecognitionNeuralNetwork_FFC(PRNN,Dataset,VIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);