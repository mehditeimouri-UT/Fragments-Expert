function [SVMModel,SVMModel_CL,Pc,ConfusionMatrix,Pc_Train,ConfusionMatrix_Train] = Build_BinarySVM_FFC(Dataset,ClassLabels,FeatureLabels,Weights,TIndex,VIndex,KernelFunction,PolynomialOrder,BoxConstraint,KernelScale)
...
[ConfusionMatrix,Pc] = ConfusionMatrix_FFC(Validation(:,end-1),label_V,ClassLabels,ClassLabels,Validation_Weights);
