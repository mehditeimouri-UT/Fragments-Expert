function [ErrorMsg,Pc,ConfusionMatrix,PredictedLabel,Scores] = Test_NaiveBayes_FFC(NaiveBayes,Dataset,TestIndex,DataClassLabels,NBClassLabels,DataFeartureLabels,NBFeartureLabels,Weights)
...
[ConfusionMatrix,Pc] = ConfusionMatrix_FFC(Test(:,end-1),PredictedLabel,DataClassLabels,NBClassLabels,Test_Weights);