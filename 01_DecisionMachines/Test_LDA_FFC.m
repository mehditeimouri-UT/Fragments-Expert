function [ErrorMsg,Pc,ConfusionMatrix,PredictedLabel,Scores] = Test_LDA_FFC(LDA,Dataset,TestIndex,DataClassLabels,LDAClassLabels,DataFeartureLabels,LDAFeartureLabels,Weights)
...
[ConfusionMatrix,Pc] = ConfusionMatrix_FFC(Test(:,end-1),PredictedLabel,DataClassLabels,LDAClassLabels,Test_Weights);
