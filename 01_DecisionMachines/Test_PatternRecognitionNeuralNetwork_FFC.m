function [ErrorMsg,Pc,ConfusionMatrix,PredictedLabel,Scores] = Test_PatternRecognitionNeuralNetwork_FFC(PRNN,Dataset,TestIndex,DataClassLabels,PRNNClassLabels,DataFeartureLabels,PRNNFeartureLabels,Weights)
...
[ConfusionMatrix,Pc] = ConfusionMatrix_FFC(Dataset(TestIndex,end-1),PredictedLabel,DataClassLabels,PRNNClassLabels,Test_Weights);
