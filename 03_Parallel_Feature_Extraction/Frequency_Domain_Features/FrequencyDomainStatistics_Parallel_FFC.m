function Features = FrequencyDomainStatistics_Parallel_FFC(fragments,N)
...
%
% Outputs:
%   Features: Each row contains [mu_1,mu_2,...,mu_N,sd_1,sd_2,...,sd_N,s_1,s_2,...,s_N]
