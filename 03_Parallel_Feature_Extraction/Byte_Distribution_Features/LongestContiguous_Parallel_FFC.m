function Lmax = LongestContiguous_Parallel_FFC(fragments)
...
%
% Outputs:
%   Lmax: Mx1 vector containing the size of the longest contiguous streak of repeating bytes in
%   fragments.
%
% Revisions:
...
Lmax = zeros(M,1);
parfor j=1:M
    Lmax(j) = LongestContiguous_Core_FFC(fragments{j});
end
