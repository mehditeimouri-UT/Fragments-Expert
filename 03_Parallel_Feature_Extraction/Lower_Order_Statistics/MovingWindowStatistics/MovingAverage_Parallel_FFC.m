function [Features] = MovingAverage_Parallel_FFC(fragments,windowSize)
...
%
% Outputs:
%   Features = Mx1 vector of [DeltaMovingAverage Delta2DeltaMovingAverage]
...
parfor j=1:M
    ...
    Features(j,:) = [DeltaMovingAverage Delta2DeltaMovingAverage];
end
