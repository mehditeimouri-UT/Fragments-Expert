function Mode = Mode_Parallel_FFC(fragments)

% This function returns mode (most frequent value) of the input fragment.
%
...
%
% Outputs:
%   Mode: Mx1 mode value of the input fragments
%
% Revisions:
