function Features = false_nearest_caller_Parallel_FFC(fragments,minemb,maxemb,rt)
...
%
% Input:
%   fragments: Cell array with length M consisting of fragments of bytes
%   minemb: Minimum embedding dimension of the vectors
%   maxemb: Maximum embedding dimension of the vectors
%   rt: ratio factor
%
% Outputs:
%   Features: The result of calling false_nearest_FFC.mexw64 is matrix with
...
M = length(fragments);
Features = zeros(M,(maxemb-minemb+1)*3);
