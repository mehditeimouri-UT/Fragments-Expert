function [Filename,TestParameters,TestResults,ErrorMsg] = Load_DecisionMachine_Test_Results_FFC
...
try
    ...
    ErrorMsg = 'Selected file is not a supported file for test results!';
end