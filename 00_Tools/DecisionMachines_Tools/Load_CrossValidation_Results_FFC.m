function [Filename,CV_Parameters,CV_Results,ErrorMsg] = Load_CrossValidation_Results_FFC
...
try
    ...
    ErrorMsg = 'Selected file is not a supported file for cross-validation results!';
end