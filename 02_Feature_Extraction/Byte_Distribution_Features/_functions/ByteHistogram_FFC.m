function histogramVector = ByteHistogram_FFC(fragment)
...
%
% Outputs:
%   histogramVector: the byte frequency vector 
...
histogramVector = histcounts(fragment,(0:256));
histogramVector = histogramVector/length(fragment);
